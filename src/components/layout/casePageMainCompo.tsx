...
// }
// export default function CasesPageMainCompo(props : CasePageProps) {
//   const { t, lang } = useLanguage();
// const { isPublic, dossiersList } = props;
...
//             <a href="/login" className="underline ml-1 font-bold">{t.casesPage.ctaLogin.button}</a> {t.casesPage.ctaLogin.description2}
//           </p>
//         </div>
//       )}
//           </div>
...
//   // Trova il dossier selezionato tramite URL
//   useEffect(() => {
//     if (dossiersList.length > 0 && codeFromUrl) {
//       const matchedCase = dossiersList.find(
//         (c) => c.code.toLowerCase() === codeFromUrl.toLowerCase()
//       );
//       if (matchedCase) {
//         setSelectedId(matchedCase.id);
//       }
//     }
//   }, [codeFromUrl, dossiersList]);

//   const selectedCase = dossiersList.find((c) => c.id === selectedId) || null;

//   // Stato per i casi salvati in localStorage
//   const [savedCases, setSavedCases] = useState<string[]>([]);

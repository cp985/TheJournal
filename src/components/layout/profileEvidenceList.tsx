...
/**
 * components/layout/evidenceList.tsx
 *
 * Lista prove/segnalazioni con espansione "Vedi tutte / Mostra meno".
 * Lo stato showAll e il calcolo di cosa mostrare sono incapsulati qui:
 * il padre passa solo la lista completa e (opzionalmente) il limite iniziale.
 *
 * Gli elementi oltre il `limit` entrano/escono con un'animazione Framer
 * Motion (fade + collapse in altezza); il chevron del bottone ruota per
 * indicare lo stato aperto/chiuso.
 */

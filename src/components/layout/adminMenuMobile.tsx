...
export default function MobileMenu({ currentTab }: MenuProps) {
  ...
  const NAV_ITEMS = [
    { id: "overview", label: t.admin.mobileMenu.overview, icon: FiPieChart },
    { id: "users", label: t.admin.mobileMenu.users, icon: FiUsers },
    { id: "dossiers", label: t.admin.mobileMenu.dossiers, icon: FiFolder },
    { id: "evidences", label: t.admin.mobileMenu.evidences, icon: FiFileText },
    { id: "map", label: t.admin.mobileMenu.map, icon: FiMapPin },
  ];

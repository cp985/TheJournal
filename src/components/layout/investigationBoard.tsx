...
//         // Evidence collegate a spina di pesce (sopra e sotto)
...
//             evData = {
//               imageUrl: ev.imageUrl || ev.url,
//               caption: ev.title || ev.caption || "Reperto Fotografico",
//             };
//           } else if (targetType === "pdf") {
//             evData = {
//               title: ev.title || "Allegato PDF",
//               description: ev.description || ev.content,
//               fileUrl: ev.fileUrl || ev.url,
//             };
//           } else {
//             evData = {
//               label: ev.label || "VERBALE CARTACEO",
//               title: ev.title || "Verbale d'Indagine",
//               description: ev.description || ev.content,
//               fileUrl: ev.fileUrl || ev.url,
//             };
//           }
...
//           // Filo rosso tratteggiato verso l'evento padre
//           newEdges.push({

...
export default async function ProfilePage() {
  ...
  // Mock dei dati letti dalla tabella 'evidence' per l'utente corrente
  const userEvidenceList = [
    {
      id: "ev-101",
      code: "PRV-9942",
      title: "Log del Server e Tracciato IP Anomalo",
      type: "Log/Network",
    ...
    },
    {
      id: "ev-102",
      code: "EVT-2026",
      title: "Incongruenza Oraria nel Punto di Incidente #3",
      type: "Segnalazione Timeline",
    ...
    },
    {
      id: "ev-103",
      code: "PRV-8812",
      title: "Cattura Schermo File Metadata Modificato",
      type: "Screenshot",
        ...
        <section className="bg-zinc-900/90 border border-zinc-800/80 rounded-2xl p-6 md:p-8 shadow-xl relative overflow-hidden backdrop-blur-sm">
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
            ...
            <div className="flex items-center gap-3 w-full md:w-auto justify-end">
              <button className="flex items-center gap-2 px-4 py-2 text-sm font-medium bg-zinc-800 hover:bg-zinc-700 text-zinc-200 border border-zinc-700 rounded-lg transition-colors shadow-sm">
